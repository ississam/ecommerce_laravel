    ...
    public function store(Request $request)
    {
       ...
       $duplicata =  Cart::search(function ($cartItem, $rowId) use ($request){
        ...
        if($duplicata->isnotempty()){
            return redirect()->route('products.index')->with('success', 'Le Produit  a déja eté ajoute avant');
        }
       ...
       return redirect()->route('products.index')->with('success', 'Nouveau produdit bien ajoute');
    }
